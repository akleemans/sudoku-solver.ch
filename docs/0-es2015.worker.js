...
/* harmony import */ var _cell__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cell */ "xTEq");
...
class Sudoku {
    constructor(cells, constraints = [], globalOptions = { useBlockUnits: true }) {
        this.cells = [];
        this.units = [];
        this.sumUnits = [];
        ...
        for (let i = 0; i < 81; i++) {
            ...
            const baseIdx = i % 9;
            const col = [];
            for (const j of lodash__WEBPACK_IMPORTED_MODULE_0__["range"](9)) {
                idx = j * 9 + baseIdx;
                if (idx !== i) {
        ...
        // Build units
        for (const idx of lodash__WEBPACK_IMPORTED_MODULE_0__["range"](9)) {
            const unit = [];
            for (const i of lodash__WEBPACK_IMPORTED_MODULE_0__["range"](9)) {
                unit.push(this.cells[idx * 9 + i]);
            }
            this.units.push(unit);
        }
        for (const rIdx of lodash__WEBPACK_IMPORTED_MODULE_0__["range"](9)) {
            const unit = [];
            for (const cIdx of lodash__WEBPACK_IMPORTED_MODULE_0__["range"](9)) {
        ...
        const unitConstraints = constraints.filter(c => c.type === _constraint_type__WEBPACK_IMPORTED_MODULE_2__["ConstraintType"].MULTI_CELL_UNIT);
    ...
    getBlockIds(idx) {
        ...
        const lineStart = lodash__WEBPACK_IMPORTED_MODULE_0__["toInteger"]((idx - idx % 9) / 9);
        const blockX = lineStart - lineStart % 3;
        for (const x of lodash__WEBPACK_IMPORTED_MODULE_0__["range"](3)) {
            for (const y of lodash__WEBPACK_IMPORTED_MODULE_0__["range"](3)) {
    ...
    isSolved() {
        ...
        for (const unit of this.units) {
            const values = lodash__WEBPACK_IMPORTED_MODULE_0__["map"](unit, 'candidates').join('');
            if (values.length !== 9) {
    ...
    isValid() {
        ...
        if (!lodash__WEBPACK_IMPORTED_MODULE_0__["every"](this.cells.map(c => c.isValid()))) {
            return false;
        }
        ...
        for (const unit of this.units) {
            const allValues = unit.map(c => c.candidates)
                ...
                .join('');
            for (const v of '123456789') {
                if (_util__WEBPACK_IMPORTED_MODULE_4__["Util"].count(allValues, v.toString()) > 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _model_solver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/solver */ "zC2P");
/* harmony import */ var _model_sudoku__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/sudoku */ "/gY8");
/* harmony import */ var _model_worker_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/worker-message */ "hFCa");
/// <reference lib="webworker" />



addEventListener('message', event => {
    const sudokuOptions = event.data;
    const sudoku = new _model_sudoku__WEBPACK_IMPORTED_MODULE_1__["Sudoku"](sudokuOptions.cells, sudokuOptions.constraints, sudokuOptions.globalOptions);
    console.log('Worker got sudoku:', sudoku);
    const solvedSudoku = _model_solver__WEBPACK_IMPORTED_MODULE_0__["Solver"].solve(sudoku);
    let status = _model_worker_message__WEBPACK_IMPORTED_MODULE_2__["WorkerStatus"].SOLVED;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SumUnit", function() { return SumUnit; });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "M+Yo");

class SumUnit {
    constructor(cells, totalSum, noDuplicates) {
        this.cells = cells;
    ...
    isValid() {
        if (_util__WEBPACK_IMPORTED_MODULE_0__["Util"].allFilled(this.cells)) {
            ...
            const unitSum = _util__WEBPACK_IMPORTED_MODULE_0__["Util"].getValueSum(this.cells);
...
class Solver {
    static solve(sudoku) {
        ...
        const stack = [[sudoku.serialize(), null]];
        ...
        while (stack.length > 0) {
            ...
            if (lastGuess === null) {
                ...
                const lastGuessIdx = lodash__WEBPACK_IMPORTED_MODULE_0__["findIndex"](possibleGuesses, g => g[0] === lastGuess[0] && g[1] === lastGuess[1]);
     ...
     */
    static calculateGuesses(sudoku) {
        const guesses = [];
